...
if (length(args)<5) {
        stop("Two first arguments must be cancer types ('Basal', 'TNBC' or 'LumA'), the third must be a valid p-value, the fourth must be a valid fold-change value and the fifth must be a valid output relative path for pdf and csv files.", call.=FALSE)
}
...
if(cancertype1 == "Basal"){d1 = brca_rnaseq.basal}
if(cancertype1 == "TNBC"){d1 = brca_rnaseq.tnbc}
if(cancertype1 == "LumA"){d1 = brca_rnaseq.luminal}
if(cancertype2 == "Basal"){d2 = brca_rnaseq.basal}
if(cancertype2 == "TNBC"){d2 = brca_rnaseq.tnbc}
if(cancertype2 == "LumA"){d2 = brca_rnaseq.luminal}
